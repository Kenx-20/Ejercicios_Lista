...
public class ProyectoListasEnlazadas {
    ...
    /*crear una lista simplemente enlazada y realizar un menu donde pueda hacer lo siguiente:
        1.Agregar 2.Mostrar 3.Ingresar al final 4.ingresar al inicio 5.mayor numero
        6.menor numero 7.pomedio 8.ordenar 9.ordenar ascendente 10.eliminar por posición*/
