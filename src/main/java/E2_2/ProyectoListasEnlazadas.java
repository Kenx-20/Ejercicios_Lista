...
public class ProyectoListasEnlazadas {
    /*Realizar un programa de una lista simplemente enlazada que pueda cumplir con las siguientes instrucciones:
        Agregar al incio, mostrar lista, añadir en la posición iesima, delvolver la posición iesima de un elemento,
        ordenar de forma creciente, verificar si una lista esta ordenada, verificar si un numero se encuentra en la lista,
        invertir lista, mostrar n elementos de la lista, agregar un numero en la lista ordenada, suprimir un numero*/
                ...
                case 4:
                    if (lista.esVacio()) {
                        ...
                        if (lista.posicionDeLaiesima(nume) != null) {
                            ...
                            System.out.println("La posicion no se encontro " + lista.posicionDeLaiesima(nume));
                        }
                        System.out.println("");
                    }
                    break;
