...
public class intercambioNumero {
    ...
    Muestras la lista, intercambias los números que se encuentren en la 2ª y 4ª posición, y muestras el nuevo 
    la lista por antalla. Utiliza al menos 3 métodos: uno para introducir los datos, otro para mostrar 
